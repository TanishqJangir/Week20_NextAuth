...
export default function Signup(){
    ...
    async function signup(){
        ...
        const response = await axios.post<{message : string}>("http://localhost:3000/api/v1/signup",{
            username : username,
            password : password
        });
    ...
    return <div className="flex justify-center items-center h-screen">
        <div className="border-2 rounded-xl flex flex-col justify-center p-10 gap-9">
            <div className="text-center text-4xl">Signup</div>
            ...
            <div className=" pl-4">Registered already <Link href={"/signin"} className="text-blue-300 underline">signin</Link></div>
        </div>
    </div>
}